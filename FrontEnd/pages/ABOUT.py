...
st.write("Access to legal guidance is often limited by cost, complexity, and availability. A legal bot can democratize this access, providing affordable, immediate, and reliable legal assistance to everyone, regardless of their financial background. By automating routine legal tasks, it lowers the barrier to quality legal support, ensuring that individuals and small businesses alike can make informed decisions without the burden of expensive legal fees")
